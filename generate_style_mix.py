...
def main():
    ...
    draw_style_mixing_figure(os.path.join('results/generated', 'style-mixing.png'), load_Gs(sys.argv[1]), w=1024, h=1024, src_seeds=[639,701,687,615,2268], dst_seeds=[888,829,1898,1733,1614,845], style_ranges=[range(0,4)]*3+[range(4,8)]*2+[range(8,18)])
